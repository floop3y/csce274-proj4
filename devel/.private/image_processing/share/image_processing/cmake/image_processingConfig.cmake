...
if("TRUE" STREQUAL "TRUE")
  set(image_processing_SOURCE_PREFIX /code/catkin_ws/src/dt-core/packages/image_processing)
  set(image_processing_DEVEL_PREFIX /code/catkin_ws/devel/.private/image_processing)
  ...
  set(image_processing_INSTALL_PREFIX /code/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_processing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/code/catkin_ws/src/dt-core/packages/image_processing/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /code/catkin_ws/devel/.private/image_processing/lib;/code/catkin_ws/devel/lib;/opt/ros/noetic/lib)
