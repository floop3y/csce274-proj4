...
if("TRUE" STREQUAL "TRUE")
  set(vehicle_detection_SOURCE_PREFIX /code/catkin_ws/src/dt-core/packages/vehicle_detection)
  set(vehicle_detection_DEVEL_PREFIX /code/catkin_ws/devel/.private/vehicle_detection)
  ...
  set(vehicle_detection_INSTALL_PREFIX /code/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vehicle_detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/code/catkin_ws/src/dt-core/packages/vehicle_detection/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /code/catkin_ws/devel/.private/vehicle_detection/lib;/code/catkin_ws/devel/lib;/opt/ros/noetic/lib)
