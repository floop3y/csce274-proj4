...
#endif
#if defined(_WIN32) && defined(EVENT_DOUBLE_CLICK)
  #undef EVENT_DOUBLE_CLICK
#endif
...
struct MD5Sum< ::duckietown_msgs::ButtonEvent_<ContainerAllocator> >
{
  ...
  {
    return "faa01e3ca1fd5567c49bd28e8a640ee1";
  }

  static const char* value(const ::duckietown_msgs::ButtonEvent_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xfaa01e3ca1fd5567ULL;
  static const uint64_t static_value2 = 0xc49bd28e8a640ee1ULL;
};
...
"uint8 EVENT_DOUBLE_CLICK = 1\n"
"uint8 EVENT_HELD_3SEC = 2\n"
"uint8 EVENT_HELD_10SEC = 3\n"
"\n"
"uint8 event\n"
;
  }
